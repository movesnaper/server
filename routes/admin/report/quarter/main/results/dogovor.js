module.exports = (req) => {
  return [
    ...
    { row: 'grey', children: [
        { col: 'col border center-text', value: `Количество договогов займа,
         по которым на конец отчётного периода обязательства не погашены или заложенные вещи не прданы, шт.`,
          children: [
