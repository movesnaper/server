...
module.exports = (req) => {
  return [
    ...
    { row: 'grey', children: [
        ...
        { col: 'border center-text', value: `Сумма задолженности по основному долгу
           по предоставленным займам на конец отчётного периода:`,
          children: [
            { col: 'border flex-center center-text', value: `общая сумма задолженности по основному долгу по предоставленным займам`},
            { col: 'border flex-center center-text', value: `сумма задолженности по основному долгу по предоставленным займам,
